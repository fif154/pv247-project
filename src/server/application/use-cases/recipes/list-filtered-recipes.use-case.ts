...
export type ListFilteredRecipesInput = z.infer<typeof listFilteredRecipesSchema>;
...
export type IListFilteredRecipesUseCase = ReturnType<typeof listFilteredRecipesUseCase>;