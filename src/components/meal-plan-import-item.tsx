...
export const MealPlanImportItem = ({ plan }: { plan: MealPlan }) => {
  ...
  return (
    <FormField
      ...
      render={({ field }) => {
        return (
          <FormItem key={plan.id} className="space-y-3 rounded-md border p-4">
            <div className="flex items-center space-x-3">
                ...
                <Checkbox
                  ...
                  onCheckedChange={(checked) => {
                    ...
                    return checked
                      ...
                      : field.onChange(
                          currentValues.filter((value) => value !== plan.id)
                        );
                  }}
                />
              </FormControl>
              <div className="flex flex-1 items-center space-x-3">
                ...
                <div className="space-y-1">
                  <FormLabel className="font-medium">{plan.name}</FormLabel>
                  <p className="text-xs">
