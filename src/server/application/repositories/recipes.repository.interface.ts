...
export interface IRecipesRepository {
  createRecipe(input: Omit<Recipe, 'id' | 'createdAt' | 'updatedAt'>): Promise<Recipe>;
  ...
  updateRecipe(id: string, input: Partial<Omit<Recipe, 'id' | 'createdBy' | 'createdAt' | 'updatedAt'>>): Promise<Recipe>;
